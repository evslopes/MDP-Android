...
class DetailsMeuDiaViewModelFactory(private val application: Application, private val meuDiaDao: MeuDiaDao) : ViewModelProvider.Factory {
    override fun <T : ViewModel?> create(modelClass: Class<T>): T {
        if (modelClass.isAssignableFrom(DetailsMeuDiaViewModel::class.java)){
            return DetailsMeuDiaViewModel(application, meuDiaDao) as T
        }
